...
| 통합 문서 (3화면+흐름 2) | `good` | **31/31 PASS** |
| 통합 문서 (3화면+흐름 2) | `bad` | **18 PASS / 13 FAIL** — 화면별 결과가 단일 문서와 동일, 오탐 0건 |
...
uv run pytest          # 테스트 331개 (vLLM 없으면 정확도 측정 54개는 자동 skip)
```
